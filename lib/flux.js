...
Emitter.prototype.emitWithCallback = function(cb, event, args) {
  var events = this.on_[event] || {}, await = _.size(events) + _.size(this.all_);

  args = [args].concat(function popAwait() {
    if (await === 0) {
...
function createActions (actions) {
  ...
  function Action_ () {
    ...
    _.each(actions, function (theAction, actionName) {
      ...
      if (actionName.indexOf("await") !== 0 ) {
        return this[actionName] = function action_action () {
      ...
      return this[actionName] = function action_action () {
        ...
        this.emitWithCallback.call(this, cb.bind(that, ret), actionName.toUpperCase(), ret);
        return null;
      }.bind(this);
    }, this);
  }
