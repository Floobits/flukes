...
function createModel(options) {
  ...
  function Model(opt_data) {
    ...
    _.each(this.schema, function (value, field) {
      ...
      if (_.has(defaults, field)) {
        this[field] = defaults[field];
        return;
      }
      if (this.schema[field].required_) {
        throw new Error("The field " + field + " is required according to you!");
      }
      this[field] = this.schema[field].defaults_;
    }, this);
    this.silent_ = false;
